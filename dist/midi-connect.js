...
exports.midiWriteSelect = exports.midiSelectBtn = exports.bindMidiAccess = void 0;
async function bindMidiAccess(port, onMidiMessage) {
...
function midiSelectBtn({ msgport, parentElement, onMidiMessage, onPortsGot, }) {
...
exports.midiSelectBtn = midiSelectBtn;
const midiWriteSelect = ({ outputs, onselect }) => {
...
exports.midiWriteSelect = midiWriteSelect;
